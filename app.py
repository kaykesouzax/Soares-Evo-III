...
MAPA_NOMES = {
    ...
    "SERGIO LOPES": "SERGIO MORENO LOPES", "SERGIO LOPES": "SERGIO MORENO LOPES",
...
VENDEDORES_PDV = {
    ...
    "CARLOS BARBOSA": "BOCA DO ACRE","SERGIO LOPES": "BOCA DO ACRE",
    ...
    try:
        ...
        with ZipFile(tmp_path, 'r') as zip_file:
            ...
            for row_elem in root.iter('{http://schemas.openxmlformats.org/spreadsheetml/2006/main}row'):
                ...
                # Pular as 3 primeiras linhas (título, data e cabeçalho)
                if row_num <= 3:
                    continue
